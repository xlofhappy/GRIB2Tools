...
import com.ph.grib2tools.grib2file.GribSection4;
import com.ph.grib2tools.grib2file.Grid2FileReader;
...
public class GRIB2FileTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<Grib2File>  grib2FileList = Grid2FileReader.readFrom(grib2File);

            for ( Grib2File file : grib2FileList ) {
                System.out.println(file.getSection0().getDisciplineName());
                for ( GribSection4 gribSection4 : file.getSection4() ) {
